...
CREATE TABLE `const_dictionary` (
  ...
  `en_us_caption` varchar(200) DEFAULT NULL,
  `zh_tw_caption` varchar(200) DEFAULT NULL,
  `zh_cn_caption` varchar(200) DEFAULT NULL,
  `seq_no` decimal(38,0) DEFAULT NULL,
  `level_no` varchar(10) DEFAULT NULL,
  `const_type` varchar(6) DEFAULT NULL,
...
CREATE TABLE `sys_resource` (
  ...
  `NAV_ENABLED` decimal(1,0) NOT NULL DEFAULT '0' COMMENT 'Nav enable',
