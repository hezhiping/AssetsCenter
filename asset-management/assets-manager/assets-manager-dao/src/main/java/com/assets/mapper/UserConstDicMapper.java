...
public interface UserConstDicMapper {
     ...
     */
    List<UserConstDic> selectUserSetDic(Map<String, Object> map);
    
   
   // List<UserConstDic> selectProfitLossPayIncomType(Map<String, Object> map);
    /**
     * 共用方法： 获取用户配置的损益分类 
    * @param  map设置一个参数;    	
    ...
    * @return 返回用户配置的项，为19,20,21,26这种形式
    */  
	List<UserConstDic> selectProfitLossType(Map<String, Object> map);
	  /**
     * 共用方法：获取用户配置的收支方式 
    * @param  map设置一个参数;    	
	 * (1)category 要查询的哪类配置: category IN ('2_ZCX','3_SRX','4_BJSY')    
    * @return 返回用户配置的项，为19,20,21,26这种形式
    */  
	List<UserConstDic> selectPayIncomType(Map<String, Object> map);    
