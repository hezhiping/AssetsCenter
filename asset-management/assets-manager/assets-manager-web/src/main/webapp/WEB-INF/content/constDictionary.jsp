	...
	function doDelete() {
		...
		$.messager.confirm('确认', '您确认想要删除记录吗？', function(r) {
			if (r) {
				...
				alert(ids);
				$.post("/assets/Dictionary/deleteDictionary/" + ids, function(result) {
...
<body class="easyui-layout" style="visibility: hidden;">
		...
		<table class="easyui-datagrid" id="grid" 
			...
			<thead>
				<tr>
					...
					<th data-options="field:'seqNo',width:160">序号</th>
					<th data-options="field:'levelNo',width:160">级别</th>
					<th data-options="field:'constType',width:160">属性类型</th>					
				</tr>
			</thead>
		</table>
	</div>
	<div id="toolbar">
		<a id="button-view" href="javascript:void(0)" class="easyui-linkbutton"  text="编辑" iconCls="icon-edit"  onclick="doEdit()"></a>
		<a id="button-add" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add"  onclick="doAdd()">新增</a>
		<a id="button-delete" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="doDelete()">删除</a>
	</div>
	<div class="easyui-window" title="添加常数" id="addDictionaryWindow"
		...
		<div region="center" style="overflow: auto; padding: 5px;"
			border="false">
			<form id="addDictionaryForm" action="/assets/Dictionary/addDictionary" method="post">
	...
	<!-- 修改窗口 -->
	<div class="easyui-window" title="修改菜单" id="editDictionaryWindow"
		collapsible="false" minimizable="false" maximizable="false"
		...
		<div region="center" style="overflow: auto; padding: 5px;"
			border="false">
			<form id="editDictionaryForm" action="/assets/Dictionary/modifyDictionary"
				method="post">
