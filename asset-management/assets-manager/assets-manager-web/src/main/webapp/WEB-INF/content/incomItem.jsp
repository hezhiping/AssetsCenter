...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#showItem').datagrid({
			...
			rownumbers : true,
			striped : true,
			url : "/assets/UserConstDic/getUserIncomDic",
			method : 'get',			
	...
	$(function() {
		...
		$("#save").click(function() {
			...
			$.post("/assets/UserConstDic/AddUserIncomDic/" + ids,
				function(result) {
	...
	<div region="center" border="false">
		<div
			...
			<div style="float: left;">
				<div class="easyui-panel" title="已配置收入项" collapsible="false"
			...
			<div style="float: left; margin-left: 160px;">
				<div class="easyui-panel" title="全部收入项" collapsible="false"
					minimizable="false" maximizable="false"
