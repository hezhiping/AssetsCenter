...
function doCancle(){		
	...
	$(function() {
		...
		$('#showItem').datagrid({
			...
			rownumbers : true,
			striped : true,
			url : "/assets/UserConstDic/getUserOlineBankDic",
			method : 'get',			
	...
	$(function() {
		...
		$("#save").click(function() {
			...
			$.post("/assets/UserConstDic/AddUserOlineBankDic/" + ids,
				function(result) {
		...
		$("#showSave").click(function() {			  
			   var updateList = [];//定义一个数据
		        ...
		        if (updateRows.length <= 0) {
		            ...
		            $.ajax({
		                type: "POST",
		                url: "/assets/UserConstDic/saveOlineBankBeginMoney",
		...
		<div
			...
			<div style="float: left;">
				<div class="easyui-panel" title="已配置银行卡" collapsible="false"
					...
					style="top: 120px; left: 200px; width: 400px; height: 450px;">
